...
func (*CreatedEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_3722887da46b2e9c, []int{7}
}
...
func (m *CreatedEvent) GetNumberOfLots() int32 {
	if m != nil {
		return m.NumberOfLots
	}
	return 0
...
func (m *BidEvent) Reset()      { *m = BidEvent{} }
func (*BidEvent) ProtoMessage() {}
func (*BidEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_3722887da46b2e9c, []int{8}
}
func (m *BidEvent) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BidEvent) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BidEvent.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BidEvent) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BidEvent.Merge(m, src)
}
func (m *BidEvent) XXX_Size() int {
	return m.Size()
}
func (m *BidEvent) XXX_DiscardUnknown() {
	xxx_messageInfo_BidEvent.DiscardUnknown(m)
}

var xxx_messageInfo_BidEvent proto.InternalMessageInfo

func (m *BidEvent) GetBid() *Bid {
	if m != nil {
		return m.Bid
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CreatedEvent)(nil), "message.CreatedEvent")
	proto.RegisterType((*BidEvent)(nil), "message.BidEvent")
}
...
var fileDescriptor_3722887da46b2e9c = []byte{
	...
	,
}
...
func (this *CreatedEvent) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CreatedEvent)
	if !ok {
		that2, ok := that.(CreatedEvent)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *BidEvent) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*BidEvent)
	if !ok {
		that2, ok := that.(BidEvent)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *CreatedEvent) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&message.CreatedEvent{")
	s = append(s, "NumberOfLots: "+fmt.Sprintf("%#v", this.NumberOfLots)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *BidEvent) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 5)
	s = append(s, "&message.BidEvent{")
	if this.Bid != nil {
		s = append(s, "Bid: "+fmt.Sprintf("%#v", this.Bid)+",\n")
	}
	s = append(s, "}")
...
func (m *CreatedEvent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CreatedEvent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CreatedEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BidEvent) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BidEvent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BidEvent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *CreatedEvent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *CreatedEvent) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&CreatedEvent{`,
		`NumberOfLots:` + fmt.Sprintf("%v", this.NumberOfLots) + `,`,
		`}`,
	}, "")
	return s
}
func (this *BidEvent) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&BidEvent{`,
		`Bid:` + strings.Replace(this.Bid.String(), "Bid", "Bid", 1) + `,`,
		`}`,
	}, "")
	return s
...
func (m *CreatedEvent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CreatedEvent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CreatedEvent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *BidEvent) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BidEvent: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BidEvent: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
